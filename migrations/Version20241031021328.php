 ...
 */
final class Version20241031021328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail (id INT NOT NULL, article_id INT NOT NULL, dette_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, qte INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, brochure_filename VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_blocked BOOLEAN NOT NULL, roles JSON NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, login VARCHAR(50) NOT NULL, password VARCHAR(60) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL ON users (login)');

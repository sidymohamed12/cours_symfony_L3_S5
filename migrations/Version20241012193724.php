 ...
 */
final class Version20241012193724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, users_id INT DEFAULT NULL, telephone VARCHAR(20) NOT NULL, adresse VARCHAR(255) NOT NULL, surnom VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');

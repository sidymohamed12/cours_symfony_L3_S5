 ...
 */
final class Version20241030190622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_blocked BOOLEAN NOT NULL, roles JSON NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, login VARCHAR(50) NOT NULL, password VARCHAR(60) NOT NULL, PRIMARY KEY(id))');

...
class getCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 6 => ($container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ?? $container->load('getWebpackEncore_EntrypointLookup_CacheWarmerService'));
            ...
            yield 9 => ($container->privates['ux.live_component.twig.cache_warmer'] ?? $container->load('getUx_LiveComponent_Twig_CacheWarmerService'));
